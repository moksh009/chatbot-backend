...
const FLOW_TEMPLATE_CATALOG = [
  {
    ...
    description:
      'End-to-end store bot for Indian D2C — product catalog, cart recovery, order tracking, returns, reviews, FAQ, business hours, and live agent handoff in one organized flow.',
