...
/**
 * Official order-status WhatsApp templates (multi-tenant safe).
 * Clients must use these names for paid / shipped / delivered so variable resolution never breaks.
 */
const ORDER_STATUS_ECO_REGISTRY = {
  paid: {
    ...
    label: 'Order paid',
    variableMappings: {
      body: { 1: 'first_name', 2: 'order_id', 3: 'order_total', 4: 'payment_method' },
    },
  },
  shipped: {
...
/**
 * Sanitize client orderStatusTemplates — core statuses only keep official eco_* names.
 */
